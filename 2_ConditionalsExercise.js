...
function exercise3(num3) {
  ...
  // Write your code for the exercise below here:
  if (num3 > 0){
    answer3 = `${num3} value is positive`;
  }else if (nun3 < 0){
       answer3 = `${num3}value is negative`;
  // --------------------------------------------
  }else {
    answer3 = `${num3} value is zero`;
  // --------------------------------------------
  // And above here
  // --------------------------------------------
  }
...
function exercise4(varA, varB) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
const sameType =typeof varA === typeof varB;
const sameValue = varA === varB;

if (sameType && sameValue &&(typeof varA === "string" || typeof varA === "number")){
...
// Unexpected “seems equal but not equal” cases:
// - "5" (string) vs 5 (number)
// - NaN is never equal to NaN
// - 0 vs false, "" vs 0, null vs undefined (loose vs strict equality)
// - "10" vs 10 (type mismatch)
// EXERCISE 6.
...
function exercise8(amount1, amount2, minimum, maximum) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
const inRange1 = amount1 >= minimum && amount1 <= maximum;

  const inRange2 = amount2 >= minimum && amount2 <= maximum;
...
function exercise9(item) {
  ...
  // Reuse the rules from exercise7
