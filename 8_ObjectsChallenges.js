...
console.log(entries(obj4)); // [["a",1],["b",2],["c",3]]
...
console.log(pluck(people, "name")); // ["Tim", "Matt", "Elie"]
...
// Examples:
// "name = Elie, job = Instructor, isCatOwner = false"
let person = { name: "Elie", job: "Instructor", isCatOwner: false };
console.log(stringFromObject(person));
