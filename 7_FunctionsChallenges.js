...
function prependToString(str,toPrepend){
...
function removeFromString(str, start, count) {
  ...
  const right = str.slice(start + count);
...
console.log(indexOf([5, 10, 15, 20], 10)); // 1

console.log(indexOf([2, 1], 2));           // 0

console.log(indexOf([2, 1], 3));           // -1
...
console.log(includes('abcd', 'a'));        // true
...
console.log(includes({ a: 1, b: 2 }, 2));  // true
